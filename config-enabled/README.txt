...
config files, which are located in the directory:
    ...
    /opt/logicmoo_workspace/packs_web/ClioPatria-filessytem-and-clausedb/config-available

For example, to enhance the system setup   for development, you may wish
to do:

    ==
    ln -s /opt/logicmoo_workspace/packs_web/ClioPatria-filessytem-and-clausedb/config-available/debug.pl
    ==

This application may  provide   additional  application-specific example
configuration files.

@see	/opt/logicmoo_workspace/packs_web/ClioPatria-filessytem-and-clausedb/config-available/README.txt
